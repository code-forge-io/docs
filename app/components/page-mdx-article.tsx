...
export default function PageMdxArticle({ page }: { page: Page }) {
	return (
		<article className="prose prose-invert w-full min-w-0 max-w-4xl flex-grow px-3 py-8 prose-headings:text-[var(--color-text-active)] prose-p:text-[var(--color-text-active)] text-sm sm:text-base md:px-6 md:py-4 md:text-lg">
